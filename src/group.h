...
class group {
    private:
        ...
        vector<pay_list> pay_list;
    public:
        group(int arg_gid);
        ~group();
        void add_people_to_group(people arg_people);
        int create_item(string arg_name, vector<int> arg_people_pay, vector<people> arg_people);
        void put_item_data(int arg_iid, vector<int> arg_people_pay, vector<people> arg_people);
...
int group::create_item(string arg_name, vector<int> arg_people_pay, vector<people> arg_people) {
...
void group::put_item_data(int arg_iid, vector<int> arg_people_pay, vector<people> arg_people) {
